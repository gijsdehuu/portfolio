...
ggplot(corpus, aes(x = Tempo, y = Danceability, color = genre)) +
  geom_point(alpha = 0.75, size = 2.5) +
  geom_smooth(method = "lm", se = TRUE, linewidth = 0.8) +
  facet_wrap(~ genre) +
  labs(
    title = "Tempo and Danceability in Italo Disco and Berlin Minimal Techno",
    subtitle = "Track-level comparison with linear trends and uncertainty bands",
    x = "Tempo (BPM)",
    y = "Danceability (0–1)"
  ) +
...
ggplot(chroma_both, aes(
  ...
  labs(
    ...
    subtitle = "Similarity of pitch-class content over time",
    x = "Time",
    y = "Time"
  ) +
  theme_minimal(base_size = 14) +
